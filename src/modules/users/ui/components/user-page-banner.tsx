  ...
  return (
    <div className="relative group">
      <BannerUploadModal
        ...
        onOpenChage={setIsBannerUploadModalOpen}
      />
      ...
      >
        {user.clerkId === userId && (
          <Button
            type="button"
            size="icon"
            className="absolute top-4 right-4 rounded-full bg-black/50 hover:bg-black/60 opcacity-100 md:opacity-0 group-hover:opacity-100 transition-opacity duration-300"
